...
I want to give a big thanks to Justin Wheeler, Bravo’s AWS expert, for helping me work through figuring out this deployment, and for contributing his thoughts on security best-practices. We simulated this work with Justin being the admin, and myself being the _Least Privilege_ developer needing the minimum required rights. Justin has struggled through this before, and also supplied the MFA shell script that I adapted for this project.
