...
My goal with this post is to get anyone comfortable with running inference on a model using Apple's open source MLX framework, and how to choose a model that is right for you.
