...
summary: "This post shows a quick way to fulfill the Google Play Store's updated Data Safety policy that requires a website form to request account deletion. This solution can be ready to deploy in 20 minutes!"
image: '/static/images/google-play-requirements/banner.png'
---

![Fulfill Google Plays Data Safety Requirements in 20 Minutes](/static/images/google-play-requirements/banner.png)

Source code available on:
[![GitHub](https://img.shields.io/badge/github-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/DaveAldon/Android-Data-Safety-Template)
...
![Policy](/static/images/google-play-requirements/policy.png)
...
![Policy](/static/images/google-play-requirements/site.png)
...
![Policy](/static/images/google-play-requirements/email.png)
...
![Policy](/static/images/google-play-requirements/deploy.png)
...
![Policy](/static/images/google-play-requirements/form.png)
...
![Success](/static/images/google-play-requirements/success.png)
